    ...
    return (
      <NavigationContainer>
        <Stack.Navigator headerMode="none"
          ...
          <Stack.Screen name="LiveSummaryMap" component={LiveSummaryMap}  options={{
            animationEnabled: false,
          }}/>
          <Stack.Screen name="LiveSummaryFromSegment" component={LiveSummaryFromSegment} />
          <Stack.Screen name="CreateNewLive" component={CreateNewLive}  options={{
            animationEnabled: false,
          }} />
