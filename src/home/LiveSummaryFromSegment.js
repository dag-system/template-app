...
class LiveSummaryFromSegment extends Component {
  ...
  onClickShare() {
    Share.share(
      {
        message:
          'Découvrez mon activité sur DigiRAID Grenoble INP  : ' +
          this.props.currentLive.statsLive.lienPartage,
        title: 'Découvrez mon activité sur DigiRAID Grenoble INP !',
      },
      {
        // Android only:
        dialogTitle: 'Découvrez mon activité sur DigiRAID Grenoble INP ! ',
      },
    );
  }
