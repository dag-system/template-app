...
export default function ConnectStrava(props: CurrentProps) {
  ...
  const config = {
    ...
    redirectUrl: 'com.fouleeblanche.app://oauthredirect',
    serviceConfiguration: {
      authorizationEndpoint: 'https://www.strava.com/oauth/mobile/authorize',
      tokenEndpoint:
        'https://www.strava.com/oauth/token?client_id=58309&client_secret=bc167b2ba6a15349c292131fa3956f6dea668b88',
    },
