    ...
    return (
      <Container>
        <Body style={styles.body}>
          ...
          onPress={() => this.onClickNavigate('Lives')} style={{ width: '100%', backgroundColor: this.props.selected == 'Lives' ? '#E9E9E9' : 'transparent' }}
          >
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent : 'flex-start', padding: 10 }}>
              <Image
                ...
                style={[styles.icon]}
              />
              <Text style={styles.menuText}>Mes activités</Text>
            </View>
          </TouchableHighlight>

          <TouchableHighlight 
          underlayColor='rgba(255,255,255,1,0.6)'
          onPress={() => this.onClickNavigate('CreateNewLive')} style={{ width: '100%'}}>
            <View style={{ display: 'flex', flexDirection: 'row' , justifyContent : 'flex-start', padding: 10 }}>
            <Image
                source={require('../assets/startLive.png')}
                style={[styles.icon]}
              />
               <Text style={styles.menuText}>Ajouter une activité</Text>
            </View>
          </TouchableHighlight>

          <TouchableHighlight
          underlayColor='rgba(255,255,255,1,0.6)'
          onPress={() => this.onClickNavigate('Preferences')} style={{ width: '100%',backgroundColor: this.props.selected == 'Preferences' ? '#E9E9E9' : 'transparent' }}>
            <View style={{ display: 'flex', flexDirection: 'row' , justifyContent : 'flex-start', padding: 10 }}>
            <Image
          ...
          <TouchableHighlight
          underlayColor='rgba(255,255,255,1,0.6)'
          onPress={() => this.onClickNavigate('Logout')}  style={{ width: '100%'}}>
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent : 'flex-start', padding: 10  }}>
            <Image
